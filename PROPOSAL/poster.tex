      ...
      \vspace{0.5em}
        ...
        \end{itemize}
          ...
          \begin{column}{0.33\textwidth}  
            ...
            \textbf{Results from [arXiv:2208.11902] (\cite{gutjahr2022}):}
            \vspace{0.5em}
            ...
            \begin{itemize}
              ...
              %\begin{itemize}
              %  \item[$\rightarrow$] The accumulated deflection primarily depends in the final muon energy and is independent of the initial energy
